...
from financial_research_agent.integrations.sec_edgar import Filing, SECEdgarClient
...
class FilingIndexer:
    ...
    def __init__(self, sec: SECEdgarClient, store: VectorStore) -> None:
        self._sec = sec
        self._store = store
    ...
    async def index_filing(
        ...
        log.info("filing_indexed", ticker=ticker.upper(), form=filing.form_type, chunks=count)
        return count